...
// Lo stato della lavorazione è interamente derivato dai timestamp.
// Non salvare mai un campo `stato` sul DB.
 ...
 *
 * pesoPerColloEffettivo della Lavorazione è il default per le pedane figlie.
